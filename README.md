...
```bash
clone-gd-addon https://github.com/ChillCube/Godot_HitflashAnimation.git
```
> [!IMPORTANT]
> Make sure to enable the addon, including its dependencies in the project settings!

## Documentation
You can find the documentation at: https://github.com/ChillCube/Godot_HitflashAnimation/blob/main/DOCUMENTATION.md

## Deinstallation
### Linux
Run this in the root of your godot project:
```bash
remove-gd-addon Godot_HitflashAnimation
```
