# Godot HitflashAnimation API Reference
...
| :--- | :--- | :--- | :--- |
| **length** | `` | `0.05` | This node is attached to a sprite or animated sprite to create a hitlflash effect. This can be used for things like indicating damage. |
